 ...
 ********   ************    **************         ***************          *
 * 1.0       2021-03-01        zhaoyang           新增IDataSplit数据切分      *
 ****************************************************************************
 *  explain:                                                                *
 *      TODO... DataSplit用数据格式化处理，把原有的数据格式切分成元组的形式          *
 ****************************************************************************/
object DataSplit {
  def dateSplit(message: String): (String, String, String, String, String, String, String, String, String, String, String, String)= {
